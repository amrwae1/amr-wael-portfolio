...
export function ValoraChapter() {
  return (
    ...
    >
      ...
      <Reveal className="border-t border-rule pt-8">
        ...
        <div className="grid-12 mt-10">
          ...
          <div className="col-span-4 self-end md:col-span-6 lg:col-span-4 lg:col-start-9">
            <p className="measure text-[0.95rem] leading-relaxed text-text-muted">{valora.status}</p>
      ...
      <Reveal variant="plate" className="mt-[var(--spacing-chapter)]">
        <EvidenceFigure
          {...dashboard}
      ...
      <Reveal variant="plate" className="grid-12 mt-[var(--spacing-chapter)]">
      ...
      <Reveal variant="plate" className="grid-12 mt-[var(--spacing-chapter)] items-end">
        <div className="col-span-4 md:col-span-8 lg:col-span-8">
          <EvidenceFigure {...evidence} sizes="(min-width: 1024px) 62vw, 100vw" note={undefined} />
        </div>
        <div className="col-span-4 md:col-span-8 lg:col-span-4">
          <EvidenceLabel kind="reasoning" />
          <p className="mt-3 measure text-[0.95rem] leading-relaxed text-text-muted">{evidence.note}</p>
        </div>
      </Reveal>
      ...
      <Reveal variant="plate" className="grid-12 mt-[var(--spacing-chapter)] items-center">
        ...
        <div className="col-span-4 md:col-span-8 lg:col-span-5 lg:col-start-7">
          <p className="measure text-[0.95rem] leading-relaxed text-text-muted">{progress.note}</p>
        </div>
      </Reveal>

      {/* System foundation --------------------------------------------- */}
      <Reveal variant="plate" className="mt-[var(--spacing-chapter)] border-t border-rule pt-10">
      ...
      <Reveal className="mt-16">
        <BoundaryNote test={valora.boundaryTest}>{valora.boundary}</BoundaryNote>
      </Reveal>
    </section>
  );
}
